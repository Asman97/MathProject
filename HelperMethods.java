...
public class HelperMethods {
    ...
    public static boolean getRestart(Scanner scanner, String name) {
        ...
        System.out.print("\n\n\nWould you like to see another " + name
    ...
    public static boolean getRestart(Scanner scanner) {
        // tODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'getRestart'");
    }
}